...
export default function SuiteSilhouetteScreen({ navigate }) {
  return (
    <div style={{ minHeight: "100vh", background: "#1B4332", color: "#fff", display: "flex", flexDirection: "column", justifyContent: "center", padding: "2rem", position: 'relative' }}>
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', flex: 1 }}>
        <h1 style={{ fontFamily: 'Playfair Display, serif', fontSize: "2.1rem", marginBottom: "1.5rem", textAlign: "center" }}>
          La silhouette s’arrête soudainement…
        </h1>
        <p style={{ fontSize: "1.1rem", maxWidth: 500, textAlign: "center", marginBottom: "2.5rem" }}>
          Tu distingues maintenant une vieille femme, enveloppée dans un pagne coloré. Elle te regarde avec des yeux brillants et te tend un objet mystérieux enveloppé dans un tissu.
        </p>
        <button
          style={{
            background: "#E87A5D",
          ...
          onClick={() => navigate && navigate("objet-mystere")}
        >
          Prendre l’objet
        </button>
      </div>
